...
class UserDaoV9Test {
    ...
    @Autowired
    private UserDaoInterfaceV2 userDaoV9;
    ...
    void setUp() {
        ...
        userDaoV9.deleteAll();
        assertEquals(0, userDaoV9.selectCount());
        userDaoV9.insertUser(user1);
        userDaoV9.insertUser(user2);
        userDaoV9.insertUser(user3);
        userDaoV9.insertUser(user4);
        assertEquals(4, userDaoV9.selectCount());
    }
